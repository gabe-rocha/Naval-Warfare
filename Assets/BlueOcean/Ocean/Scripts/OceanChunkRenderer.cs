...
namespace Ocean
{
    ...
    public class OceanChunkRenderer : MonoBehaviour
    {
        ...
        void OnWillRenderObject()
        {
            ...
            {
                _mpb.SetFloat(Shader.PropertyToID("_SSRMaxSampleCount"), OceanRenderer.Instance._ssrMaxSampleCount);
                _mpb.SetFloat(Shader.PropertyToID("_SSRSampleStep"), OceanRenderer.Instance._ssrSampleStep);
                _mpb.SetFloat(Shader.PropertyToID("_SSRIntensity"), OceanRenderer.Instance._ssrIntensity);
            }
